...
function newWorld(seed){ startWorld(seed, {}); viewCamp = camps[0]; $('seed').value = seedText; followId = null; lvl = 0; worldDirty = 0; acc = 0; const a = firstPerson(); setView('loc', secOf(a.x, a.y)); }
