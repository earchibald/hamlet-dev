...
const API = `return {
  ...
  settle, beginCreation, paintSectors, paintGround, paintRivers, paintLakes, paintScars, paintHeights, paintDepths, placeFirstPerson, uplift, cutWaterCaves, rockfall, BIOMES, FEATURES, paintCreatures, wasMade, placeBodies, placeGrove, spawnAnimal, placeFinds, digGnomeBurrows, godsTick, SPAWN,
  ...
  campHumans, humans, firstPerson, stashFood,
