...
const API = `return {
  ...
  startWorld, step, advance, nextEvent, runTo, pinBucket, resetPins, get pins(){ return pins; }, get moves(){ return moves; }, inject, DOOR_ACTS, DOOR_SOURCES, lightTile, poke, pitLit, goalState, GOALS, STAGES, stageReached, log, SPECIES, GROUND, ITEMS, LIFE,
