...
const API = `return {
  ...
  startCreation, runAges, ageStep, ageBegin, ageDecide, ageEnd, get agePos(){ return agePos; }, restGate, isStart, isLevel, startCandidates, strain, godOptions, decideGod, godNeeds, settleHome, unmake, GOD_ACTS, GOD_NAMES, EPITHET, BODY, LEAVES, SCAR_OF, MAKES, STRAIN, KINDS, polesThatMake, outgrown, REGIONS_PER_GOD,
