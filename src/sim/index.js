...
const API = `return {
  ...
  RECIPES, recipeGoal, placeFor, offersFor, setSite, tryLightning, nearbyBlaze, LW, LH, chooseSite, startClearDen, startDeliver, startFoundCamp, addItem, removeItem, rebuildItemGrid, stashAdd, gardenLives, DIRS,
  ...
  get faith(){ return faith; }, set faith(v){ faith = v; }, FAITH, FAITH_TEXT, PRAYERS, faithTick, startFaith, giveBeliefs, wardPoints, tallyLine, isEvening, nextDawn, beastNear, underRoof, endStorm, burningNear, foodTarget,
