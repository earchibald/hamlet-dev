...
const API = `return {
  ...
  CLOCK, DAY, SEASON_LENGTHS, YEAR_DAYS, ticks, strides, tickRate, strideRate, lookRate, stock, secs, mins, hours, days, years, perHour, rollFor,
  seasonOf, dayOf, dayOfYear, yearOf, hourOf, isNight, isWinter, stage, ageDays, mood, threatsFor,
