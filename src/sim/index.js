...
const API = `return {
  ...
  startCreation, runAges, ageStep, ageBegin, ageDecide, ageEnd, endAges, get agePos(){ return agePos; }, get pending(){ return pending; }, get inhabited(){ return inhabited; }, takeTurn, releaseTurn,
