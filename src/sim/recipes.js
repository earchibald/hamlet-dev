...
const RECIPES = [
  ...
  { id: 'cord', title: 'Twist cord', stage: 'crafts', after: 'firepit', needs: { fibre: 4 }, place: 'stash', skill: 'craft', work: CLOCK.work.cord, makes: { item: 'cord', n: 2 }, standing: { stash: 'cord', n: 4 }, score: 36,
    verb: 'twists', blurb: 'Four bundles of fibre make two coils. Cord binds a rod, a basket, and clothes.' },
  { id: 'workshop', title: 'Build the workshop', stage: 'crafts', after: 'axe', needs: { log: 6, stick: 10, rock: 4 }, tools: ['axe'], place: 'site', skill: 'build', work: CLOCK.work.workshop, makes: { struct: 'workshop' }, score: 46,
  ...
  { id: 'basket', title: 'Weave a basket', stage: 'crafts', after: 'workshop', needs: { cord: 3 }, place: 'workshop', skill: 'craft', work: CLOCK.work.basket, makes: { tool: 'basket' }, score: 40,
  ...
  { id: 'rod', title: 'Make a fishing rod', stage: 'crafts', after: 'workshop', needs: { stick: 1, cord: 2 }, place: 'workshop', skill: 'craft', work: CLOCK.work.rod, makes: { tool: 'rod' }, score: 40,
  ...
  { id: 'clothes', title: 'Sew hide clothes', stage: 'crafts', after: 'workshop', needs: { hide: 3, cord: 1 }, place: 'workshop', skill: 'craft', work: CLOCK.work.clothes, makes: { wear: 'clothes' }, standing: { stash: 'hide', n: 0 }, active: () => campHumans().some(h => !h.clothes), score: 50,
  ...
  { id: 'kiln', title: 'Build the kiln', stage: 'crafts', after: 'workshop', needs: { rock: 8, clay: 4 }, place: 'site', skill: 'build', work: CLOCK.work.kiln, makes: { struct: 'kiln' }, score: 42,
  ...
  { id: 'pot', title: 'Fire pots', stage: 'crafts', after: 'kiln', needs: { clay: 3, stick: 2 }, place: 'kiln', skill: 'craft', work: CLOCK.work.pot, makes: { item: 'pot', n: 1 }, counts: 'fired', standing: { stash: 'pot', n: 3 }, score: 38,
  ...
  { id: 'garden', title: 'Plant a garden', stage: 'crafts', after: 'axe', needs: { cuttings: 4 }, tools: ['axe'], place: 'garden', skill: 'gather', work: CLOCK.work.garden, makes: { garden: true }, score: 36,
  ...
  { id: 'pitfall', title: 'Dig a deer pit', stage: 'crafts', after: 'axe', needs: { log: 4, cord: 2 }, tools: ['axe'], place: 'pitfall', skill: 'trap', work: CLOCK.work.pitfall, makes: { pitfall: true }, standing: { stash: 'venison', n: 0 }, active: () => camp.pitfalls.length < 2, score: 34,
