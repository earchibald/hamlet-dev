...
const RECIPES = [
  { id: 'fibre', title: 'Gather fibre', stage: 'crafts', after: 'firepit', place: 'reeds', gather: a => startPickFibre(a), standing: { stash: 'fibre', n: 6 }, score: 30, offerLabel: 'gather fibre from the reeds',
    blurb: 'Reed fibre twists into cord. Reeds grow in the marsh and along the water.' },
  { id: 'cord', title: 'Twist cord', stage: 'crafts', after: 'firepit', needs: { fibre: 4 }, place: 'stash', skill: 'craft', work: 30, makes: { item: 'cord', n: 2 }, standing: { stash: 'cord', n: 4 }, score: 40,
    verb: 'twists', blurb: 'Four bundles of fibre make two coils. Cord binds a rod, a basket, and clothes.' },
  { id: 'workshop', title: 'Build the workshop', stage: 'crafts', after: 'axe', needs: { log: 6, stick: 10, rock: 4 }, tools: ['axe'], place: 'site', skill: 'build', work: 140, makes: { struct: 'workshop' }, score: 50,
  ...
  { id: 'basket', title: 'Weave a basket', stage: 'crafts', after: 'workshop', needs: { cord: 3 }, place: 'workshop', skill: 'craft', work: 60, makes: { tool: 'basket' }, score: 44,
  ...
  { id: 'rod', title: 'Make a fishing rod', stage: 'crafts', after: 'workshop', needs: { stick: 1, cord: 2 }, place: 'workshop', skill: 'craft', work: 40, makes: { tool: 'rod' }, score: 44,
  ...
  { id: 'fish', title: 'Fish the river', stage: 'food', after: 'rod', tools: ['rod'], place: 'water', gather: a => startFish(a), standing: { stash: 'fish', n: 4 }, active: () => camp.stash.fish < 4 && stashFood() + camp.stash.fish * 2 < foodTarget(), score: 38, offerLabel: 'fish the river',
    blurb: 'A fish cooks to two meals or smokes on the rack. People fish when food is short.' },
  { id: 'clothes', title: 'Sew hide clothes', stage: 'crafts', after: 'workshop', needs: { hide: 3, cord: 1 }, place: 'workshop', skill: 'craft', work: 70, makes: { wear: 'clothes' }, standing: { stash: 'hide', n: 0 }, active: () => campHumans().some(h => !h.clothes), score: 42,
  ...
  { id: 'clay', title: 'Dig clay', stage: 'crafts', after: 'workshop', place: 'bank', gather: a => startDigClay(a), standing: { stash: 'clay', n: 6 }, score: 32, offerLabel: 'dig clay',
    blurb: 'Clay from the riverbank. Four lumps build a kiln, three fire a pot.' },
  { id: 'kiln', title: 'Build the kiln', stage: 'crafts', after: 'workshop', needs: { rock: 8, clay: 4 }, place: 'site', skill: 'build', work: 120, makes: { struct: 'kiln' }, score: 46,
  ...
  { id: 'pot', title: 'Fire pots', stage: 'crafts', after: 'kiln', needs: { clay: 3, stick: 2 }, place: 'kiln', skill: 'craft', work: 50, makes: { item: 'pot', n: 1 }, standing: { stash: 'pot', n: 3 }, score: 42,
  ...
  { id: 'garden', title: 'Plant a garden', stage: 'crafts', after: 'axe', needs: { cuttings: 4 }, tools: ['axe'], place: 'garden', skill: 'gather', work: 80, makes: { garden: true }, score: 40,
  ...
  { id: 'pitfall', title: 'Dig a deer pit', stage: 'crafts', after: 'axe', needs: { log: 4, cord: 2 }, tools: ['axe'], place: 'pitfall', skill: 'trap', work: 90, makes: { pitfall: true }, standing: { stash: 'venison', n: 0 }, active: () => camp.pitfalls.length < 2 && !!deerNear(), score: 38,
  ...
  { id: 'quarry', title: 'Quarry stone', stage: 'crafts', after: 'axe', tools: ['axe'], place: 'face', gather: a => startQuarry(a), standing: { stash: 'rock', n: 6 }, score: 41, offerLabel: 'quarry rocks',
