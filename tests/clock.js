...
test('the camp rules and the cellular systems read the table', () => {
  ...
  assert.deepEqual(C.arrival, { first: 700, firstSpread: 600, firstByHand: 700, secondHearth: 900, wait: 900, spread: 900, chance: 0.7, villageChance: 0.85, afterTheLast: 10000 });
