...
function oldAgeClaimSkip(days){
  return days >= OLD_AGE_CLAIM_DAYS ? false
    : `${days} days: the old-age claim is made on runs of ${OLD_AGE_CLAIM_DAYS} days or more, which is a lower bound carried over from dev and not a floor measured at this clock (G4 task 4 owes the measurement)`;
}
