...
| Save and load | G, time and tiers, section 3 | idea | Snapshots through a table of reference fields. Save to a file, one autosave slot at dawn. `load` passes the door. Tasks are data since plan G2. Plan G3 builds it. |
