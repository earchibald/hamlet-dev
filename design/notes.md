...
- A tile cursor lives on the map. Arrows move it, Shift by five, Alt by a sector (not Ctrl: macOS takes Ctrl with an arrow for Mission Control). Enter applies the tool. Home goes to the hearth, W to the world map at the camp. The mouse moves it too. The foot names what is under it.
