...
| 3 | A being's head off the tick: state from elapsed time, a cheap proximity pass each tick | the same, and a world day in under 5 s. **Day 3 met: 2.99 to 3.40 s across six runs, at one-minute load averages from 2.62 to 4.36, against 9.86 s before. Day 50 missed at 17.98 s with 82 people.** |
